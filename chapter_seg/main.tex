...
can be seen in Figure~\ref{fig:gt-vs-un}. As we may observe the
...
results can be seen in Figure~\ref{fig:visual}. Also, performance over
all components for all methods is given in Figure~\ref{fig:all}.
...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth]{figs/all.eps}
