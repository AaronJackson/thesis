...
- [ ] Page 34, suggest to move the dataset description to a section
  ...
  - I'm not really sure how I can structure this better. The subsection
    we it would be merged with is under Results, and I feel like this
    makes a lot of sense.  The training datasets are described in a
    section under Method. Perhaps changing the titles to "Training
    Datasets" and "Evaluation Datasets" would suffice?
...
- [ ] Page 43, add statistical tests of results to demonstrate
  ...
  and testing.
  - I have included p-values for a paired t-test, showing whether the
    tests were significant for conclusions 1 (comparing with other
...
- [ ] Page 48, mention metrics employed in the caption of table.
  - Not sure I understand. The caption says normalized mean error is
    used.
