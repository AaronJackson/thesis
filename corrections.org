...
- [X] Page 34, suggest to move the dataset description to a section
  ...
  - I'm not really sure how I can structure this better. The
    subsection we it would be merged with is under Results, and I feel
    like this makes a lot of sense.  The training datasets are
...
- [X] Reference, use uniform style.
  - While the style was consistent, many of the journal or conference
    names were different. Additionally, many details were missing from
    many of the bibliography entries. I have gone through these to
    ensure they are all correct and consistent. There are of course
    still variations between articles, in proceedings and technical
    reports, as defined by the IEEE referencing style.

- [ ] All minor typographic error and missing references are annotated
...
- [X] Generally, it is not a good practice to use reference as part of
  ...
  - I have corrected the cases I can find.
